...
We decided to develop Gilbert as an open source project so that everyone can benefit from the project.
...
Additionally, Gilbert also supports Mahout as a secondary math back end.
The user can select on demand which system he wants to use depending on his personal preference.
The inclusion of Mahout also emphasizes the extensible architecture of Gilbert which can easily be extended with new math libraries.
